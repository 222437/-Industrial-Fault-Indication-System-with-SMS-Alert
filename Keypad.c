...
/*int main()
{
	//led's are connected to p0.8-p0.15 and 
	//making those port pins are output port pins
	IODIR0 = 0x0000FF00;

	//superloop
	while(1)
	{	
		ch = keyscan();//calling keyscan function
		IOPIN0 = ch<<8;//display binary equivalent of switch press on 8 active high led's
	}
